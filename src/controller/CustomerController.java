...
public class CustomerController {
        ...
        void OnCustomerSaveButton() {
                ...
                try {
                        ...
                        if (customerNameText.getText().isBlank() || customerNameText.getText().isBlank() ||
                                customerPhoneNumberText.getText().isBlank() || customerAddressText.getText().isBlank() ||
                                customerPostalCodeText.getText().isBlank() ||
                                customerDivisionCombo.getSelectionModel().getSelectedItem() == null){

                                ControllerUtilities.ErrorException("Blank fields in customer information", "Please put at least " +
                                        "one character in every text field and select a division to save the customer");
                                return;
                        }

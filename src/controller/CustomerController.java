...
//TODO add more checks for new or editting when clear button pressed
        ...
        void OnCustomerSaveButton(ActionEvent event) throws Exception {
                ...
                // customer is added to customer list from DBLocations (need to look up country and division by divisionID)
        ...
        void OnDeleteCustomerButton() {
                ...
                if (selectedCustomer != null) {
                        System.out.println("Selected customer is not null");
                        ...
                        if (!filteredApptsByCustomer.isEmpty()) {
                                ...
                                if (ControllerUtilities.DeleteConfirmation(deleteConfirmString)) {
                                        ...
                                        for (Appointment appt: filteredApptsByCustomer) {
                                                ...
                                                System.out.println("Deleted customer appointment");
                                        }

                                        System.out.println("appointments left: " + AppointmentCalendar.filterApptByCustomer(selectedCustomer));

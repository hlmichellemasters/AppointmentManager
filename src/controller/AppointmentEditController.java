...
//                        System.out.println("Set Up Appointments TableView");
        ...
        public void initializeAddEditAppt() {
                try {
                        ...
                        userList.addAll(User.getAllUsersFromDB());
        ...
        void OnApptSaveButton(ActionEvent event) throws Exception {
                ...
                new Appointment(apptID, apptTitle, apptDescription, apptLocation, apptType, apptStart, apptEnd, apptUser,
...
//TODO add more checks for new or editting when clear button pressed
        ...
        public void OnSortApptEditTableView(ActionEvent event) {

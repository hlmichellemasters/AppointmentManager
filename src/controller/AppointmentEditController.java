...
public class AppointmentEditController {
        ...
        public void initializeAddEditAppt() {
                try {
                        ...
                        customerList = CustomerList.provideCustomerList();
        ...
        void OnApptSaveButton() {
                ...
                // if new appointment add directly to calendar
                if (apptID == DbAppointments.getNextApptID()) AppointmentCalendar.addApptToCalendar(appointment);
